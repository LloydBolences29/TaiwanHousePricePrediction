...
# --- 2. Feature Selection ---
X = df[['House Age', 'Distance to nearest MRT station']]
y = df['Price']
...
# --- 6. Evaluation ---
# Rubric: Report Accuracy (R2 and RMSE) for both training and test sets
...
# A. Plotting Scatter Points (Train & Test)
# Note: We use X_train and X_test (unscaled) here so the axes show real years/meters
...
# B. Plotting the Prediction Surface
